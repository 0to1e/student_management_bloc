...
import 'package:softwarica_student_management_bloc/features/batch/data/data_source/local_data_source/batch_local_data_source.dart';
...
class BatchLocalRepository implements IBatchRepository {
  ...
  Future<Either<Failure, void>> createBatch(BatchEntity batchEntity) async {
    try {
      await _batchLocalDataSource.createBatch(batchEntity);
      return Right(null);
    } catch (e) {
